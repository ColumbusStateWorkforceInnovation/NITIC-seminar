...
**Try it:** scale your cache tier to **5 replicas** with the `--set` form, then confirm in `k9s`. Then think through *why* the file-vs-flag distinction matters — one survives a redeploy, the other doesn't.
